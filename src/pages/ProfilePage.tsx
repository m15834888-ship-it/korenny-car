  ...
  return (
    <div className="pb-24 px-4 pt-4">
      ...
      >
        ...
        <h2 className="text-lg font-bold text-center" style={{ color: '#e0e0e5' }}>{user.name}</h2>
        <p className="text-sm text-center" style={{ color: '#8888a0' }}>{user.email}</p>
        {(isAdmin || isSuperAdmin) && (
          <span className="block text-center mt-2 px-3 py-1 rounded-full text-[10px] font-bold mx-auto w-fit"
      ...
      <div className="space-y-3">
        {/* Language */}
        <div className="rounded-2xl p-4" style={{ background: 'rgba(20, 20, 24, 0.8)', border: '1px solid rgba(212, 175, 55, 0.1)' }}>
        ...
        <div className="rounded-2xl p-4" style={{ background: 'rgba(20, 20, 24, 0.8)', border: '1px solid rgba(212, 175, 55, 0.1)' }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              {isDark ? <Moon className="w-4 h-4" style={{ color: '#D4AF37' }} /> : <Sun className="w-4 h-4" style={{ color: '#D4AF37' }} />}
            ...
            >
              <span
                ...
                style={{ [document.documentElement.dir === 'rtl' ? 'right' : 'left']: isDark ? '26px' : '2px' }}
              />
            </button>
          </div>
        </div>
        ...
        {isAdmin && (
          ...
          >
            ...
            <ChevronLeft className="w-4 h-4" style={{ color: '#8888a0' }} />
          </button>
        )}
